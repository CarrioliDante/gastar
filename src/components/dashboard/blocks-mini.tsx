  ...
  return (
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
        ...
        <Link
          href="/blocks"
          style={{ color: "rgba(0,0,0,0.3)", fontSize: 11, textDecoration: "none" }}
        >
          All →
        </Link>
      </div>
          ...
          return (
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 14 }}>
                ...
                <span style={{ color: "rgba(0,0,0,0.3)", fontSize: 10, fontWeight: 500, letterSpacing: "0.04em" }}>
                  {pct}%
                </span>
              </div>
              ...
              <p style={{ color: "rgba(0,0,0,0.35)", fontSize: 10, marginBottom: 12 }}>
                ${block.spent.toLocaleString()} spent
              </p>
